          ...
          <form role="form" action="{{route('patient.update',$patient['id'])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="feedback">{{$patient['feedback']}}</textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="address" placeholder="Address"  value="{{$patient['address']}}">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Age</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="age" placeholder="Age"  value="{{$patient['age']}}">
              </div>
              <div class="form-group">
